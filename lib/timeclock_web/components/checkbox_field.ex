defmodule TimeclockWeb.Components.CheckboxField do
  @moduledoc """
  TimeclockWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
