defmodule TimeclockWeb.Components.Combobox do
  @moduledoc """
  The `TimeclockWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/combobox
  ...
  import TimeclockWeb.Components.ScrollArea, only: [scroll_area: 1]
