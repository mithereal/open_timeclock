defmodule TimeclockWeb.Components.Alert do
  @moduledoc """
  TimeclockWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
