defmodule TimeclockWeb.Components.Tabs do
  @moduledoc """
  `TimeclockWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import TimeclockWeb.Components.Badge, only: [badge: 1]
