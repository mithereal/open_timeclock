defmodule TimeclockWeb.Components.Sidebar do
  @moduledoc """
  The `TimeclockWeb.Components.Sidebar` module provides a versatile and customizable sidebar
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/sidebar
  ...
  def sidebar(assigns) do
    ...
    <aside
      ...
      role="complementary"
      class={[
        "h-screen transition-transform z-10 overflow-x-hidden",
