defmodule TimeclockWeb.Components.Stepper do
  @moduledoc """
  The `TimeclockWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `TimeclockWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/stepper
  ...
  import TimeclockWeb.Components.Icon, only: [icon: 1]
