defmodule TimeclockWeb.Components.Gallery do
  @moduledoc """
  The `TimeclockWeb.Components.Gallery` module provides a customizable gallery component for displaying
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/gallery
  ...
  attr :height, :string, default: "56", doc: "Media Height"
  attr :width, :string, default: "56", doc: "Media Width"
  ...
  attr :class, :string, default: nil, doc: "Custom CSS class for additional styling"
  attr :src, :string, default: nil, doc: "Media link"
  attr :height, :string, default: "1024", doc: "Media Height"
  attr :width, :string, default: "1024", doc: "Media Width"
  attr :alt, :string, default: "", doc: "Media link description"
  attr :rounded, :string, default: "none", doc: "Determines the border radius"
  attr :shadow, :string, default: "shadow-none", doc: "Determines shadow style"
  ...
  def gallery_photoswipe(assigns) do
    ~H"""
