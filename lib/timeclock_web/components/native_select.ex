defmodule TimeclockWeb.Components.NativeSelect do
  @moduledoc """
  The `TimeclockWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `TimeclockWeb.Components.NativeSelect`
