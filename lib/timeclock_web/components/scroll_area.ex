defmodule TimeclockWeb.Components.ScrollArea do
  @moduledoc """
  The `TimeclockWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/scroll-area
  ...
  attr :horizontal, :boolean, default: false, doc: "Enables horizontal scrollbar visibility"
  attr :vertical, :boolean, default: true, doc: "Enables vertical scrollbar visibility"
  ...
  attr :class, :string, default: nil, doc: "Custom CSS class for the scroll area wrapper"
  attr :content_class, :string, default: nil, doc: "Custom CSS class for the inner content area"

  attr :scrollbar_width, :string,
    default: "w-2",
    doc: "Custom CSS class for vertical scrollbar width"

  attr :scrollbar_height, :string,
    default: "h-2",
    doc: "Custom CSS class for horizontal scrollbar height"
