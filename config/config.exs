...
config :ash,
  ...
  policies: [no_filter_static_forbidden_reads?: false, private_fields: :include],
...
config :timeclock, TimeclockWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: TimeclockWeb.ErrorHTML, json: TimeclockWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Timeclock.PubSub,
  live_view: [signing_salt: "+U8HZ3aj"]
